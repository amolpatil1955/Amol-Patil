...
// ============================================================
// MERN STACK PORTFOLIO - PRODUCTION READY - SINGLE JSX FILE
// ============================================================
...
const SKILLS = {
  Frontend: [
    { name: "React.js", level: 95, icon: "fab fa-react", color: "#61DAFB" },
    { name: "Next.js", level: 90, icon: "fas fa-n", color: "#FFFFFF" },
    { name: "TypeScript", level: 88, icon: "fas fa-code", color: "#3178C6" },
    {
      name: "Tailwind CSS",
      level: 92,
    ...
    { name: "Three.js", level: 80, icon: "fas fa-cube", color: "#00FF88" },
    { name: "Redux", level: 85, icon: "fas fa-layer-group", color: "#764ABC" },
  ],
  Backend: [
    { name: "Node.js", level: 93, icon: "fab fa-node-js", color: "#8CC84B" },
    { name: "Express.js", level: 90, icon: "fas fa-server", color: "#00FF88" },
    { name: "REST APIs", level: 95, icon: "fas fa-plug", color: "#FF6B6B" },
    {
      name: "GraphQL",
      level: 82,
    ...
    { name: "WebSockets", level: 78, icon: "fas fa-wifi", color: "#00C9FF" },
    {
      name: "JWT Auth",
      level: 88,
  ...
  Database: [
    { name: "MongoDB", level: 92, icon: "fas fa-leaf", color: "#4DB33D" },
    {
      name: "PostgreSQL",
      level: 85,
    ...
    { name: "Mongoose", level: 90, icon: "fas fa-sitemap", color: "#8A0000" },
  ...
  DevOps: [
    ...
    { name: "CI/CD", level: 82, icon: "fas fa-infinity", color: "#00FF88" },
    {
      name: "Git & GitHub",
      level: 95,
      icon: "fab fa-github",
    ...
    { name: "Linux", level: 88, icon: "fab fa-linux", color: "#FCC624" },
    {
      name: "Nginx",
      level: 78,
...
const PROJECTS = [
  {
    ...
    desc: "Enterprise-grade e-commerce solution with real-time inventory management, AI-powered recommendations, payment gateway integration with Stripe & Razorpay, admin dashboard with analytics, and microservices architecture.",
    tech: [
      "React",
      "Node.js",
      "MongoDB",
...
const EXPERIENCE = [
  ...
  //   period: "2020 – 2022",
  //   type: "Full-Time",
  //   desc: "Developed 15+ client projects using MERN stack. Implemented CI/CD pipelines, Dockerized deployments, and automated testing frameworks achieving 95% test coverage.",
  //   achievements: [
  ...
  //   period: "2019 – 2020",
  //   type: "Internship",
  //   desc: "Designed RESTful APIs for fintech startup, integrated third-party payment gateways, and optimized MongoDB queries resulting in 40% faster response times.",
  //   achievements: [
  //     "40% faster APIs",
  //     "Payment integration",
  //     "3 products shipped",
  ...
  //   period: "2018 – 2019",
  //   type: "Freelance",
  //   desc: "Delivered 25+ web projects for clients across 8 countries. Specialized in React frontends and Node.js backends for SaaS, e-commerce, and portfolio websites.",
  //   achievements: [
  //     "25+ projects",
  //     "8 countries",
  //     "98% client rating",
...
const STATS = [
  { value: "5+", label: "Years Experience", icon: "fas fa-calendar-alt" },
  { value: "80+", label: "Projects Completed", icon: "fas fa-project-diagram" },
  { value: "50+", label: "Happy Clients", icon: "fas fa-smile" },
  { value: "2M+", label: "Users Served", icon: "fas fa-users" },
];
  ...
  return (
    <div
      ...
      style={{
        ...
        borderColor: hovered ? project.color : "transparent",
        boxShadow: hovered
          ? `0 0 40px ${project.color}33, 0 0 80px ${project.color}11`
          : "none",
      }}
      ...
      <div className="project-card-inner">
        ...
        >
          <i
            ...
            style={{ color: project.color, fontSize: "1.6rem" }}
          />
        </div>
...
function ExperienceCard({ exp, index }) {
  ...
  return (
    <div
      ref={ref}
      className={`exp-card ${vis ? "visible" : ""}`}
    ...
    >
      ...
      <div className="exp-content">
        <div className="exp-header">
          <div>
            <h3 className="exp-role" style={{ color: exp.color }}>
              {exp.role}
            </h3>
          ...
          <div className="exp-meta">
            <span className="exp-period">
              <i className="fas fa-calendar" /> {exp.period}
            </span>
...
export default function Portfolio() {
  ...
  return (
    <>
      {/* CSS STYLES */}
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Space+Grotesk:wght@300;400;500;600;700&family=Syne:wght@400;500;600;700;800&family=JetBrains+Mono:wght@400;500;600;700&display=swap');
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .loader-e { color: var(--blue); }
        .loader-r { color: var(--red); }
        .loader-n { color: var(--gold); }
        .loader-name {
          font-family: var(--font-display);
          font-size: 1.1rem; font-weight: 600;
          color: var(--text2); letter-spacing: 0.4em;
        ...
        .nav-cta:hover { transform: translateY(-1px); box-shadow: 0 8px 24px rgba(0,255,136,0.3); }
        ...
        .typewriter-text { color: var(--green); }
        .typewriter-cursor {
          color: var(--green);
        ...
        .btn-primary:hover { transform: translateY(-2px); box-shadow: 0 12px 32px rgba(0,255,136,0.35); }
        .btn-secondary {
          padding: 0.85rem 2rem;
        ...
        .hero-avatar::before {
          ...
          background: radial-gradient(circle at 70% 30%, rgba(0,255,136,0.15), transparent 60%),
                      radial-gradient(circle at 30% 80%, rgba(0,201,255,0.1), transparent 60%);
        }
        .avatar-ring {
          position: absolute;
          border-radius: 50%;
        ...
        .avatar-ring-1 { width: 380px; height: 380px; top: -20px; left: -20px; animation-duration: 20s; }
        .avatar-ring-2 { width: 430px; height: 430px; top: -45px; left: -45px; animation-duration: 30s; animation-direction: reverse; }
        ...
        .about-accent {
          ...
          border-radius: 20px;
          background: linear-gradient(135deg, rgba(0,255,136,0.12), rgba(0,201,255,0.08));
        ...
        .about-intro span { color: var(--green); }
        .about-para {
          color: var(--text2); font-size: 0.97rem;
        ...
        .about-highlight i { color: var(--green); font-size: 0.85rem; }
        ...
        .project-card {
          ...
          position: relative; overflow: hidden;
          opacity: 0; transform: translateY(30px);
          transition: all 0.6s cubic-bezier(0.4,0,0.2,1), border-color 0.3s, box-shadow 0.3s;
          cursor: default;
        }
        ...
        .proj-btn:hover { transform: translateY(-1px); opacity: 0.9; }
        ...
        .exp-line {
          width: 2px; margin: 0 2rem;
          min-height: 100%;
          border-radius: 2px; opacity: 0.5;
        }
        .exp-icon {
          position: absolute; left: 1.4rem; top: 1.8rem;
        ...
        /* STATS SECTION */
        #stats { padding: 5rem 0; background: var(--bg3); }
        .stats-grid {
        ...
        .stat-card:hover { transform: translateY(-4px); border-color: rgba(0,255,136,0.25); }
        .stat-card::before {
          content: '';
        ...
        .contact-item:hover { border-color: rgba(0,255,136,0.25); transform: translateX(4px); }
        .contact-item-icon {
        ...
        .form-submit:hover { transform: translateY(-2px); box-shadow: 0 10px 28px rgba(0,255,136,0.3); }
        ...
        .footer-inner {
          display: flex; justify-content: space-between;
          align-items: center; flex-wrap: gap; gap: 1.5rem;
        }
        .footer-logo {
          font-family: var(--font-display);
        ...
        .back-to-top:hover { transform: translateY(-2px); box-shadow: 0 12px 32px rgba(0,255,136,0.4); }
      ...
      <div className={`mobile-menu ${menuOpen ? "open" : ""}`}>
        {NAV_LINKS.map((n) => (
          <div key={n} className="mobile-menu-link" onClick={() => scrollTo(n)}>
            {n}
          </div>
        ))}
      </div>
          ...
          <div className="container">
            <div className="hero-inner">
              <div className="hero-left">
                ...
                <h1 className="hero-name">Amol Patil</h1>
            ...
            <div className="about-grid">
              ...
              <div className="about-text">
                <h3 className="about-intro">
                  Building the <span>future</span> of the web, one commit at a
                  time.
                </h3>
                ...
                <div className="about-highlights">
                  {[
                    ...
                    { icon: "fas fa-globe", text: "Available In India" },
                    {
                      ...
                      text: "English, Hindi, Gujarati , Marathi",
                    },
                  ].map((h) => (
            ...
            <div className="contact-grid">
              <div className="contact-info">
                <h3>
                  ...
                  <span style={{ color: "var(--green)" }}>Extraordinary</span>
                </h3>
                <p>
        ...
        <div className="container">
          <div className="footer-inner">
            ...
            <div className="footer-copy">
              © 2024 Amol Patil. Built with <span>❤</span> using MERN Stack &
              Three.js
            </div>
